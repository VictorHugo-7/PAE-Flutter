...
class WebSobreLinksAppBar extends StatefulWidget {
  const WebSobreLinksAppBar({super.key});
  @override
  State<WebSobreLinksAppBar> createState() => _WebSobreLinksAppBarState();
}

class _WebSobreLinksAppBarState extends State<WebSobreLinksAppBar> {
  @override
